...
所有服务跑在 Docker Compose 里，compose 文件在 `/vol1/1000/Docker/`。
...
4. **旧 qb 目录迁移**：从旧路径迁移到 MoviePilot 管理路径，释放了 3.8TB 空间，83 个孤儿文件需要手动处理
